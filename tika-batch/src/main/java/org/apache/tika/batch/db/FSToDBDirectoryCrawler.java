...
public class FSToDBDirectoryCrawler extends FileResourceCrawler {

    private final Path root;
    private final Comparator<Path> pathComparator = new FileNameComparator();
    private final Connection connection;

    public FSToDBDirectoryCrawler(ArrayBlockingQueue<FileResource> fileQueue,
                                  int numConsumers, Path root, Connection connection,
    ...
    private void addFiles(Path directory) throws InterruptedException {
        ...
        if (directory == null) {
            logger.warn("FSToDBDirectory asked to process null directory?!");
            return;
        }
