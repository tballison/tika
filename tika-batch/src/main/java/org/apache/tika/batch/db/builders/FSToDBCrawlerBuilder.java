package org.apache.tika.batch.db.builders;
 ...
 */
public class FSToDBCrawlerBuilder implements ICrawlerBuilder {
    ...
    private final static String DB_CONNECTION_ATTR = "dbConnectionString";
